...
interface ImageLabelingIconProps {
  active: boolean;
}

const ImageLabelingIcon: React.FC<ImageLabelingIconProps> = ({ active }) => {
  return (
    <IconTemplate active={active} name="Image Labeling" viewBox="0 0 512 512">
...
export default ImageLabelingIcon;
