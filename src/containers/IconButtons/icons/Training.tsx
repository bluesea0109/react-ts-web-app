  ...
  return (
    <Box className={classes.root}>
      <Box className={classes.Icon}>
        ...
        <path
          d="M10 13.2504C9.88685 13.2504 9.77566 13.222 9.67744 13.168L3.9875 10.0419C3.88687 9.98601 3.76288 9.98605 3.66229 10.042C3.56171 10.0979 3.49983 10.2012 3.5 10.3129V13.2504C3.4998 13.4775 3.62782 13.6869 3.83434 13.7972L9.68434 16.9214C9.88065 17.0262 10.1193 17.0262 10.3157 16.9214L16.1657 13.7972C16.3722 13.6869 16.5002 13.4775 16.5 13.2504V10.3129C16.5002 10.2012 16.4383 10.0979 16.3377 10.042C16.2371 9.98605 16.1131 9.98601 16.0125 10.0419L10.3226 13.168C10.2243 13.222 10.1131 13.2504 10 13.2504Z"
        />
        <path
