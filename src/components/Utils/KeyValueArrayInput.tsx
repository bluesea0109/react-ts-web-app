    ...
    <Grid xs={12} ref={ref}>
      ...
      <Box mb={3}>
        <Grid container direction="row" alignItems="flex-end" xs={12}>
          <Grid item xs={6} style={{ maxWidth: 200, paddingRight: 8 }}>
          ...
          <Box mt={isMobile ? 2 : 0}>
            <Button className={classes.addBtn} style={{ height: 43 }} variant={'outlined'} disabled={(currentItem ?? "") === '' || disabled} onClick={onAdd}>
              Add
            </Button>
          </Box>
        </Grid>
