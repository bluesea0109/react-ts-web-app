...
=======
import { CHATBOT_DELETE_TEMPLATE, CHATBOT_GET_TEMPLATES } from '../../../gql-queries';
...
function TagsTable() {
  ...
  const templates = templatesData.data && templatesData.data.ChatbotService_templates;
  return (
                ...
                <TableRow key={template.id}>
                  ...
                  <TableCell>
                     ...
                     <ConfirmDialog
                        ...
                        onConfirm={() => deleteTemplateHandler(Number(template.id))}
