...
export const createOptionMutation = gql`
  mutation(
    $agentId: Int!
    $userTextResponseOption: ChatbotService_TextOptionInput
    $userImageResponseOption: ChatbotService_ImageOptionInput
    $upsert: Boolean
  ) {
    ChatbotService_createUserResponseOption(
      agentId: $agentId
      userTextResponseOption: $userTextResponseOption
      userImageResponseOption: $userImageResponseOption
      upsert: $upsert
    ) {
      id
      type
...
export const updateOptionMutation = gql`
  mutation(
    ...
    ChatbotService_updateUserResponseOption(
      id: $id
      userTextResponseOption: $userTextResponseOption
      userImageResponseOption: $userImageResponseOption
    ) {
